...
$insertPoint = $content.IndexOf('<!-- 报告卡片 3 - 新能源 -->')
...
"@
    ...
    $newContent = $content.Insert($insertPoint, $newCards)
    Set-Content index.html $newContent -Encoding UTF8 -NoNewline
    Write-Host "Homepage updated successfully with 6 new report cards!"
} else {
